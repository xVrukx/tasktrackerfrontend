...
export const App = () => {
  ...
  const GetTaskfunc = async() => {
    const res = await fetch("https://tasktrackerbackend-692n.onrender.com/api/getTasks",{
      method:"GET",
...
const UpdateTaskFunc = async (id, status) => {
    const res = await fetch(`https://tasktrackerbackend-692n.onrender.com/api/updateTasks/${id}`, {
        method: "POST",
        headers: {
  ...
  const DeleteTaskfunc = async(id) => {
    const res = await fetch(`https://tasktrackerbackend-692n.onrender.com/api/deleteTasks/${id}`,{
      method:"POST",
      headers:{"Content-Type":"application/json"}
    });
    if(!res.ok) {
...
const AddTaskfunc = async () => {
  ...
  const res = await fetch("https://tasktrackerbackend-692n.onrender.com/api/addTasks", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
